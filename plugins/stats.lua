...
local function run(msg, matches)
  if matches[1]:lower() == 'pershian' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "pershian" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) (pershian)",-- Put everything you like :)
		"^[!/]([Pp]ershian)"-- Put everything you like :)
    "^([Ss]tats)$",
    "^([Ss]tatslist)$",
    "^([Ss]tats) (group) (%d+)",
    "^([Ss]tats) (pershian)",-- Put everything you like :)
